                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="formLogisitico">
                                    <input type="hidden" id="idcausa" name="idcausa" />
                                    <div class="row">
                                        <div class="col-md-12">
                                            <hr />
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-5">
                                            <button type="submit" class="btn btn-success verificarDonacion">Verificar Donaci&oacute;n</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        $(document).ready(function(){
            ...
            $("#tabladonacionasignada").on('click', '.btn-asignar', function(){
                ...
                try{
                    ...
                    if( checked )
                    {
                        throw 'Debe seleccionar al menos una donación para verificar'
                    }
            ...
            $("#formLogisitico").submit(function(event){
                ...
                if(flag)
                {
                    ...
                    formData.append('metodo', 'GESTIONARDONACIONESV2')
                    ...
                    $.ajax({
                        ...
                        error: function(err)
                        {
                            ...
                            beforeSend: function()
                            {
                                $(".verificarDonacion").prop({'disabled': true}).html('<i class="fa fa-spinner fa-spin"></i> procesando, espere....! ');
                            },
                                ...
                                columns: [
                                    ...
                                    },
                                    {
                                        ...
                                        render: function ( data, type, row ){
                                            return `<button type="button" class=" btn btn-success btn-asignar"> VERIFICAR </button>`
                                        }
                                    }
                                ]
                            })
